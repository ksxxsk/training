package coursera.week3.quicksort.quiz;
 ...
 * the carpenter can see which one is bigger (but the carpenter cannot compare two nuts or two bolts directly). Design
 * an algorithm for the problem that uses nlogn compares (probabilistically).
 */
